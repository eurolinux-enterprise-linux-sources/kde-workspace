...
Patch1: kde-workspace-4.10.3-redhat_startkde.patch
...
# add a new panel to bottom by default
Patch63: kde-workspace-bz#1067111-panel-placing.patch
...
Patch102: kde-workspace-4.10.5-CVE-2013-4132.patch
Patch103: kde-workspace-4.10.5-CVE-2013-4133.patch
...
Patch107: kde-workspace-4.10.5-solid-bz#1109987.patch
Patch108: kde-workspace-4.11-bz#1040678.patch
Patch109: kde-workspace-4.11-bz#1090492.patch
Patch110: kde-workspace-4.11-bz#1109936.patch
...
Requires: kactivities%{?_isa} >= %{version}
...
for f in kcontrol/colors kmenuedit kcontrol/windowbehaviour kcontrol/kwindecoration \
   ...
   if [ -f %{buildroot}%{_kde4_docdir}/HTML/en/$f/index.cache.bz2 ] ; then
     ...
     sed -i -e 's!href="#ftn.id[a-z]*[0-9]*"!!g' %{buildroot}%{_kde4_docdir}/HTML/en/$f/index.cache
     sed -i -e 's!id="ftn.id[a-z]*[0-9]*"!!g' %{buildroot}%{_kde4_docdir}/HTML/en/$f/index.cache
